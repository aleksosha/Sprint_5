...
class TestConstructor:
    ...
    def test_go_to_buns_constructor(self, driver):
        ...
        assert WebDriverWait(driver, 5).until(
            expected_conditions.visibility_of_element_located(BurgerPartsNames.LABEL_TOPPINGS)).text == 'Булки'
    ...
    def test_go_to_sauces_constructor(self, driver):
        ...
        assert WebDriverWait(driver, 5).until(
            expected_conditions.visibility_of_element_located(BurgerPartsNames.LABEL_TOPPINGS)).text == 'Соусы'
